...
namespace ViDu1
{
    class InfoTest
    {
        public static List<NhomCauHoiDto> DanhSachNhomCauHoi = new List<NhomCauHoiDto>();
        ...
        public static string sThoiGian = "";
        public static string sNgayThi = "";
        public static string sThangThi = "";
        public static string sNamThi = "";
        public static int iSoDe = 1;
        public static string sMaDeTu = "";
        public static string sMaDeTuDen = "";
        public static string sMaDeDen = "";
        public static List<string> iDanhSachTenDe = new List<string>();
        public static string sTenCau = "";
        public static int iCauBatDau = 1;
